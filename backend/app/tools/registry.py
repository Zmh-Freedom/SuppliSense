...
_EVIDENCE_TOOLS = {
    ...
    "scenario_simulate", "list_formal_suppliers", "search_suppliers", "discover_supplier_candidates", "discover_web_suppliers", "investigate_supplier_monitoring", "get_monitor_review_queue",
}
_CAPABILITIES = {
    ...
    "check_alert": "risk_monitoring", "investigate_supplier_monitoring": "risk_monitoring", "get_watchlist": "risk_monitoring", "analyze_watchlist_trend": "risk_monitoring", "get_monitor_review_queue": "risk_monitoring",
