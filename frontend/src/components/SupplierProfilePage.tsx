...
export default function SupplierProfilePage() {
  ...
  return <div className="max-w-5xl mx-auto py-6 px-4">
    ...
    {tab === 'risk' && <RiskTab supplierId={id!} compliance={compliance} esg={esg} />}
