...
1. 前置检查：确认 `GET http://127.0.0.1:8002/health/ready` 返回 200，MongoDB、Redis、PostgreSQL 和 sourcing-risk checkpoint 均为 `ok`；前端使用 Vite `127.0.0.1:5173`。原验收地址 `50008` 未监听，按开发配置切换到 5173，未修改业务逻辑。
